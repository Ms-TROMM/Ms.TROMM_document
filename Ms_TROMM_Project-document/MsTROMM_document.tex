...
\begin{enumerate}
    ...
    \item Android Studio \\ 
    \centerline{\includegraphics[scale=0.9]{as.png}}
    ...
    \item Firebase\\\\
    \includegraphics[scale=0.7]{firebase.png}
    ...
    \item Datagrip \\ \\
    \centerline{\includegraphics[scale=0.5]{datagrip.png}}
    ...
    \item Marshmallow \\ \\
    \centerline{\includegraphics [scale=0.3] {marshmallow.png}}
    ...
    \item XCode \\ 
    \centerline{\includegraphics[scale=0.3]{xcode.png}}
    ...
    \item Google API \\ 
    \centerline{\includegraphics[scale=0.3]{googleapi.jpg}}
...
\begin{enumerate}
    ...
    \centerline{\includegraphics[scale=0.25]{온보딩.png}}
    \begin{itemize}
...
\centerline{\includegraphics[scale=0.15]{Overall architecture.jpg}}
...
\begin{table} [h]
    ...
    \begin{tabular}{l|l|l}
    \hline
    \textit{\textbf{Directory}} & \textit{\textbf{File Name}} & \textit{\textbf{Part Name}}
     & & & \\ \hline
    \textit{\begin{tabular}[c]{@{}l@{}}document/\\Ms.TROMM\\-Project\\-document\\\\\\\\\end{tabular}} & \textit{\begin{tabular}[c]{@{}l@{}}Ms.TROMM-document.pdf\\Ms.TROMM-document.tex\\\\\\\\\\\end{tabular}} 
    & \textit{\begin{tabular}[c]{@{}l@{}}documentation\\\\\\\\\\\\\end{tabular}} \\ \hline
    \end{tabular}
    \renewcommand{\thetable}{\arabic{table}}
...
\centerline{\includegraphics[scale=0.5]{flow_1.png}}
...
\end{enumerate}
\centerline{\includegraphics[scale=0.5]{flow_2.png}}
\begin{enumerate}
    \item Login Button\\
...
\centerline{\includegraphics[scale=0.5]{flow_3.png}}
\begin{enumerate}
    \item Basic item\\
